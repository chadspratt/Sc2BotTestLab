"""
Django settings for Sc2BotTestLab project.
...
DATABASE_DIR = Path(r'C:\Users\inter\Documents\db')
...
ROOT_URLCONF = 'Sc2BotTestLab.urls'
...
WSGI_APPLICATION = 'Sc2BotTestLab.wsgi.application'
